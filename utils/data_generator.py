...
def execute_data_generation():
    ...
    generator.save_to_json(generator.students, "dataset/students_dataset.json")
    generator.save_to_json(generator.events, "dataset/library_events.json")
    generator.save_to_csv(generator.students, "dataset/students_dataset.csv")
    generator.save_to_csv(generator.events, "dataset/library_events.csv")
